...
typedef  block<__m128i> keyblock_t;
  ...
  static constexpr unsigned rounds = 1;     // Number of rounds
  static constexpr unsigned numofboxes = 182; // Number of Sboxes
...
int main(int argc, char * argv[])
{
  ...
  // Stores the round constants
    ...
    LowMC_constants.open("roundconstants_randomness.h");
